...
Route::prefix('public')->group(function () {
    ...
    Route::get('courses/{course_id}/curriculum', [PublicCourseController::class, 'curriculum']);
...
Route::middleware('auth:sanctum')->prefix('user')->group(function () {
    ...
    Route::prefix('schedule')->group(function () {
        Route::get('/', [ScheduleController::class, 'getUserSchedule']);
        Route::get('/upcoming', [ScheduleController::class, 'getUpcomingClasses']);
        Route::get('/{schedule_id}', [ScheduleController::class, 'getScheduleDetails']);
        Route::get('/{schedule_id}/resources', [ScheduleController::class, 'getScheduleResources']);
    ...
    Route::prefix('notifications')->group(function () {
        ...
        Route::patch('/preferences', [NotificationController::class, 'updateNotificationPreferences']);
    });
    ...
    Route::prefix('payments')->group(function () {
        ...
        Route::get('/{payment_id}', [PaymentController::class, 'getPaymentDetails']);
    });
    
    // Review Management
    Route::prefix('reviews')->group(function () {
        Route::get('/', [ReviewController::class, 'getUserReviews']);
        Route::post('/', [ReviewController::class, 'createReview']);
        Route::get('/reviewable-batches', [ReviewController::class, 'getReviewableBatches']);
        Route::get('/{review_id}', [ReviewController::class, 'getReview']);
        Route::patch('/{review_id}', [ReviewController::class, 'updateReview']);
        Route::delete('/{review_id}', [ReviewController::class, 'deleteReview']);
    });
});

// Certificate Verification (Public)
Route::post('/certificates/verify', function (Request $request) {
