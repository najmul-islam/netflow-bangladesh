<x-filament-panels::page.simple>
    <div class="fi-simple-main-ctn">
        ...
        <div class="text-center mb-8">
            <div
                class="mx-auto w-20 h-20 bg-gradient-to-br from-[#0B2E58] to-[#F76704] rounded-2xl flex items-center justify-center mb-6 shadow-xl">
        ...
        <div class="space-y-6">
            ...
            <x-filament::button type="submit" form="authenticate" size="lg"
